  ...
  const slidesData = useMemo(() => [
    {
      ...
      media: { src: "/models/mahindra-1.png", alt: "Custom Headrest" },
      accentColor: "#8B4513"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      heroHeading: "Your Car is More than a Drive",
      content: [
        "It’s your personal space. Style, customise, and craft every detail to suit your unique lifestyle."
      ],
  ...
  <p>
    {slide.content.map((text, idx) => (
      <span
        ...
        style={{ animationDelay: `${0.3 * idx}s` }} // stagger effect
      >
        {text}
      </span>
    ))}
